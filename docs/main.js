    ...
    const lcData = [
      ...
      {
        title: 'Thẩm định giá', sub: 'Value Agent hỗ trợ khách hàng tiếp cận dịch vụ định giá',
        items: ['Tư vấn khách hàng lựa chọn dịch vụ định giá', 'Thu thập thông tin tài sản', 'Yêu cầu dịch vụ trên hệ thống'],
        agent: 'Value Agent',
    ...
    const coopData = {
      ...
      value: { title: 'Value Agent', sub: 'Agent định giá — Dịch vụ thẩm định', items: ['Tư vấn khách hàng lựa chọn dịch vụ định giá', 'Thu thập thông tin tài sản', 'Yêu cầu dịch vụ trên hệ thống'] },
